// fallbackData.js — Client-side starter data for games, flashcards, grammar and drills
  ...
  spanish: [
    {
      ...
      part_of_speech: "noun",
      pronunciation_rule: "Femenino que toma el artículo 'el' en singular por empezar con 'a' tónica: el agua.",
      grammar_rule: "Sustantivo femenino: el agua clara / las aguas.",
      sentence: "Bebo un vaso de agua fresca por la mañana.",
      language: "spanish",
      correct_streak: 1,
    },
    {
      ...
      initial_form: "amistad",
      transcription: "[a.misˈtað]",
      part_of_speech: "noun",
      pronunciation_rule: "La 'd' final se pronuncia suave o relajada.",
      grammar_rule: "Sustantivo femenino abstracto terminado en -dad.",
      sentence: "La verdadera amistad no conoce fronteras.",
      language: "spanish",
      correct_streak: 1,
    },
    {
      id: "starter_es_3",
      word: "Esperanza",
      correction: "hope / ümid",
      initial_form: "esperanza",
      transcription: "[es.peˈɾan.sa]",
      part_of_speech: "noun",
      pronunciation_rule: "La 'z' se pronuncia como /s/ en Hispanoamérica y /θ/ en España.",
      grammar_rule: "Sustantivo femenino.",
      sentence: "Siempre mantenemos viva la esperanza.",
      language: "spanish",
      correct_streak: 0,
    },
  ],
  german: [
    {
      ...
      transcription: "[ˈvasɐ]",
      part_of_speech: "noun",
      pronunciation_rule: "Das 'W' wird als weiches [v] gesprochen, 'ss' als scharfes [s].",
      grammar_rule: "Neutrum: das Wasser. Unzählbares Nomen.",
      sentence: "Bitte trinken Sie jeden Morgen ein Glas frisches Wasser.",
      language: "german",
      correct_streak: 1,
    },
    {
      ...
      word: "Freundschaft",
      correction: "friendship / dostluq",
      initial_form: "Freundschaft",
      transcription: "[ˈfʁɔʏntʃaft]",
      part_of_speech: "noun",
      pronunciation_rule: "'eu' wird als Diphthong [ɔʏ] gesprochen.",
      grammar_rule: "Femininum: die Freundschaft (-schaft bildet immer feminine Nomen).",
      sentence: "Wahre Freundschaft übersteht jede Entfernung.",
      language: "german",
      correct_streak: 1,
    },
    {
      id: "starter_de_3",
      word: "Verstehen",
      correction: "to understand / başa düşmək",
      initial_form: "verstehen",
      transcription: "[fɛɐ̯ˈʃteːən]",
      part_of_speech: "verb",
      pronunciation_rule: "Unbetontes Präfix 'ver-', 'st' am Silbenanfang als [ʃt].",
      grammar_rule: "Unregelmäßiges Verb: verstehen, verstand, verstanden.",
      sentence: "Ich verstehe die Grammatik jetzt viel besser.",
      language: "german",
      correct_streak: 0,
    },
  ],
...
export function getStarterFlashcards(targetLanguage = "english") {
  ...
  if (langKey.includes("span")) return STARTER_FLASHCARDS.spanish;
  if (langKey.includes("germ")) return STARTER_FLASHCARDS.german;
  return STARTER_FLASHCARDS.english;
}

export function getStarterGrammarTopics() {
...
export function getClientFallbackGameCards(targetLanguage = "english", round = 1) {
  ...
  const isEs = langKey.includes("span");
  const isDe = langKey.includes("germ");
  ...
  if (isEs) {
    return [
      { id: "c_es_1", word: "agua", initial_form: "agua", correction: "water", transcription: "[ˈa.ɣwa]", part_of_speech: "noun", language: "spanish" },
      { id: "c_es_2", word: "amigo", initial_form: "amigo", correction: "friend", transcription: "[aˈmi.ɣo]", part_of_speech: "noun", language: "spanish" },
      { id: "c_es_3", word: "tiempo", initial_form: "tiempo", correction: "time / weather", transcription: "[ˈtjem.po]", part_of_speech: "noun", language: "spanish" },
      { id: "c_es_4", word: "mundo", initial_form: "mundo", correction: "world", transcription: "[ˈmun.do]", part_of_speech: "noun", language: "spanish" },
      { id: "c_es_5", word: "buen día", initial_form: "buen día", correction: "good day", transcription: "[bwen ˈdi.a]", part_of_speech: "phrase", language: "spanish" },
      { id: "c_es_6", word: "libro nuevo", initial_form: "libro nuevo", correction: "new book", transcription: "[ˈli.βɾo ˈnwe.βo]", part_of_speech: "phrase", language: "spanish" },
    ];
  }

  if (isDe) {
    return [
      { id: "c_de_1", word: "Wasser", initial_form: "Wasser", correction: "water", transcription: "[ˈvasɐ]", part_of_speech: "noun", language: "german" },
      { id: "c_de_2", word: "Freund", initial_form: "Freund", correction: "friend", transcription: "[fʁɔʏnt]", part_of_speech: "noun", language: "german" },
      { id: "c_de_3", word: "Morgen", initial_form: "Morgen", correction: "morning", transcription: "[ˈmɔʁɡn̩]", part_of_speech: "noun", language: "german" },
      { id: "c_de_4", word: "guten Tag", initial_form: "guten Tag", correction: "good day", transcription: "[ˌɡuːtn̩ ˈtaːk]", part_of_speech: "phrase", language: "german" },
      { id: "c_de_5", word: "neues Buch", initial_form: "neues Buch", correction: "new book", transcription: "[ˈnɔʏəs buːx]", part_of_speech: "phrase", language: "german" },
      { id: "c_de_6", word: "schönes Wetter", initial_form: "schönes Wetter", correction: "nice weather", transcription: "[ˈʃøːnəs ˈvɛtɐ]", part_of_speech: "phrase", language: "german" },
    ];
  }
