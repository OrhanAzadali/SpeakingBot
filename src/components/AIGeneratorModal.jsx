      ...
      if (type === "roadmap") {
        ...
        if (json.success && json.roadmap) {
          const newRoadmap = {
            ...
            targetLanguage: json.data.targetLanguage || targetLanguage,
            estimatedDuration: json.data.estimatedDuration || "3 Weeks",
            summary: json.data.summary || `Custom generated AI Roadmap for ${targetLanguage} with NLP tokenization.`,
        ...
        if (json.success && json.guide) {
          const newGuide = {
            ...
            fileSize: "2.1 MB",
            summary: json.data.summary || `Custom generated AI Grammar Guide for ${targetLanguage} with NLP tokenization.`,
