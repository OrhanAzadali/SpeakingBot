      ...
      if (type === "roadmap") {
        ...
        if (json.success && json.roadmap) {
          const newRoadmap = {
            ...
            title: json.roadmap.title || topic,
            category: json.roadmap.category || category,
            level: json.roadmap.level || level,
            targetLanguage: json.roadmap.targetLanguage || targetLanguage,
            estimatedDuration: json.roadmap.estimatedDuration || "3 Weeks",
            summary: json.roadmap.summary || `Custom generated AI Roadmap for ${targetLanguage} with NLP tokenization.`,
            milestones: json.roadmap.milestones || [],
            checkpointQuestions: json.roadmap.checkpointQuestions || [],
            isAiGenerated: true,
            tags: ["AI Generated", targetLanguage, category, level],
            pagesCount: 5,
            fileSize: "1.9 MB"
          };
        ...
        const json = await res.json();
        if (json.success && json.guide) {
          const newGuide = {
            id: `pdf-ai-${Date.now()}`,
            title: json.guide.title || topic,
            category: json.guide.category || category,
            level: json.guide.level || level,
            targetLanguage: json.guide.targetLanguage || targetLanguage,
            pagesCount: json.guide.pagesCount || 4,
            fileSize: "2.1 MB",
            summary: json.guide.summary || `Custom generated AI Grammar Guide for ${targetLanguage} with NLP tokenization.`,
            coreRules: json.guide.coreRules || [],
            commonMistakes: json.guide.commonMistakes || [],
            practiceExercises: json.guide.practiceExercises || [],
            isAiGenerated: true,
            tags: ["AI Generated", targetLanguage, category, level],
            downloadsCount: 1
          };
