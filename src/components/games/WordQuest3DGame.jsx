  ...
  return (
    <div className="space-y-4 max-w-4xl mx-auto select-none">
      ...
      {isPlaying && currentPrompt && (
        <div className="bg-gradient-to-r from-slate-900 via-indigo-950/80 to-slate-900 border border-sky-500/40 rounded-2xl p-4 text-center space-y-1 shadow-xl relative">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-mono text-sky-400 uppercase tracking-widest">
              Challenge Exemplar
            </span>
            {onSaveToVocabulary && currentPrompt.targetWord && (
              <SaveToVocabButton
                word={currentPrompt.targetWord}
                translation={currentPrompt.nativeHint || ''}
                example={currentPrompt.sentence}
                pos="noun"
