...
export const Header = ({
  ...
  const tabs = [
    ...
    { id: "roadmaps", label: t("tabRoadmaps"), icon: "🗺️" },
    { id: "games", label: t("tabGames"), icon: "🎮" },
    { id: "grammar-pdfs", label: t("tabGrammarPdf"), icon: "📄" },
    { id: "stories", label: t("tabStories"), icon: "📖" },
    { id: "placement-test", label: t("tabPlacementTest"), icon: "🎯" },
    { id: "skill-tests", label: t("tabSkillTests"), icon: "📊" },
    { id: "nlp-analyzer", label: t("tabNlpAnalyzer"), icon: "🔬" }
  ];
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-base tracking-tight text-white hover:text-sky-300 transition">SpeakBot</span>
