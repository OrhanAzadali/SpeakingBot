...
const MULTILINGUAL_SKILL_TESTS = {
  German: {
    grammar: [
      {
        skill: "grammar",
        question: 'Wählen Sie die korrekte Verb-Zweit-Stellung: "Morgen _____ wir die neue Grammatikregel."',
        options: ["lernen", "wir lernen", "haben gelernt", "lernen wir"],
        correctIndex: 3,
        explanation: 'Im Hauptsatz mit Adverbialbestimmung an Position 1 folgt das finite Verb an Position 2 ("lernen wir").'
      },
      {
        skill: "grammar",
        question: 'Welcher Satz steht im korrekten Konjunktiv II der Gegenwart?',
        options: [
          "Wenn ich reich bin, kaufe ich ein Haus.",
          "Wenn ich reich wäre, würde ich ein Haus kaufen.",
          "Wenn ich reich war, kaufte ich ein Haus.",
          "Wenn ich reich gewesen wäre, kaufte ich ein Haus."
        ],
        correctIndex: 1,
        explanation: 'Konjunktiv II drückt irreale Wünsche/Bedingungen in der Gegenwart aus ("wäre ... würde kaufen").'
      }
    ],
    vocabulary: [
      {
        skill: "vocabulary",
        question: 'Was ist das Synonym für "nachhaltig"?',
        options: ["kurzfristig", "dauerhaft / zukunftsfähig", "oberflächlich", "veraltet"],
        correctIndex: 1,
        explanation: '"Nachhaltig" bezeichnet eine langfristig wirkende, ressourcenschonende Entwicklung.'
      }
    ],
    reading: [
      {
        skill: "reading",
        question: 'Was ist der Hauptzweck einer wissenschaftlichen Zusammenfassung (Abstract)?',
        options: [
          "Einen fiktiven Dialog darzustellen",
          "Kernelemente, Methodik und Ergebnisse der Forschung prägnant zu umreißen",
          "Persönliche Meinungen des Autors aufzuzählen",
          "Literaturverweise zu verschleiern"
        ],
        correctIndex: 1,
        explanation: 'Ein Abstract fasst Forschungsfragen, Methoden und Resultate präzise zusammen.'
      }
    ],
    listening: [
      {
        skill: "listening",
        question: 'Welche phonologische Assimilation tritt bei "haben" in der Umgangssprache oft auf?',
        options: ["Vollständige Vokaldehnung", "Reduktion der Endsilbe zu [hamb] oder [ham]", "Betonung auf -en", "Aspiration von b"],
        correctIndex: 1,
        explanation: 'In der schnellen Umgangssprache wird das Schwa getilgt und das n assimiliert.'
      }
    ],
    speaking: [
      {
        skill: "speaking",
        question: 'Welche Formulierung eignet sich am besten für eine diplomatische Meinungsäußerung?',
        options: [
          "Das ist absolut falsch.",
          "Meines Erachtens könnte man diesen Aspekt differenzierter betrachten.",
          "Niemand teilt Ihre Ansicht.",
          "Sie haben überhaupt keine Ahnung."
        ],
        correctIndex: 1,
        explanation: '"Meines Erachtens..." fungiert als diplomatischer Diskursmarker zur höflichen Relativierung.'
      }
    ]
  },
  Spanish: {
    grammar: [
      {
        skill: "grammar",
        question: '¿Qué opción requiere el modo subjuntivo?',
        options: [
          "Es seguro que él viene mañana.",
          "Es posible que él venga mañana.",
          "Veo que él viene mañana.",
          "Sé que él viene mañana."
        ],
        correctIndex: 1,
        explanation: '"Es posible que" expresa duda o probabilidad e induce subjuntivo ("venga").'
      }
    ],
    vocabulary: [
      {
        ...
        options: ["duradero", "fugaz / pasajero", "eterno", "estático"],
        correctIndex: 1,
        explanation: '"Efímero" describe algo que dura muy poco tiempo.'
      }
    ],
    reading: [
      {
        skill: "reading",
        question: '¿Cuál es la función principal de un marco teórico en un ensayo académico?',
        options: [
          "Contar anécdotas personales",
          "Fundamentar los conceptos y corrientes científicas que respaldan la investigación",
          "Publicar poemas",
          "Resumir noticias de prensa"
        ],
        correctIndex: 1,
        explanation: 'El marco teórico contextualiza los fundamentos conceptuales de la investigación.'
      }
    ],
    listening: [
      {
        skill: "listening",
        question: 'En español hablado, el fenómeno de sinalefa se define como:',
        options: [
          "La pronunciación enfática de consonantes",
          "La unión fonética de la vocal final de una palabra con la inicial de la siguiente",
          "La eliminación de sílabas átonas",
          "La duplicación de consonantes"
        ],
        correctIndex: 1,
        explanation: 'La sinalefa fusiona vocales contiguas en una sola emisión silábica.'
      }
    ],
    speaking: [
      {
        skill: "speaking",
        question: '¿Qué marcador discursivo es más idóneo para matizar una discrepancia con cortesía?',
        options: [
          "Estás totalmente equivocado.",
          "Desde mi punto de vista, cabría considerar otros factores.",
          "Eso no tiene sentido.",
          "Cualquiera sabe que eso es falso."
        ],
        correctIndex: 1,
        explanation: '"Desde mi punto de vista, cabría considerar..." atenúa la aserción y aporta elegancia retórica.'
      }
    ]
  },
  English: {
...
function getSkillTestsForLanguage(targetLang = "English") {
  const norm = (targetLang || "English").toLowerCase();
  if (norm.includes("german") || norm.includes("deutsch")) {
    return MULTILINGUAL_SKILL_TESTS.German;
  }
  if (norm.includes("spanish") || norm.includes("español")) {
    return MULTILINGUAL_SKILL_TESTS.Spanish;
  }
  return MULTILINGUAL_SKILL_TESTS.English;
}
  ...
  return <div className="space-y-6 pb-16">
    ...
    {activeSkillModal && <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in">
      ...
      >
        ...
        {skillTests[activeSkillModal]?.[currentTestIndex] && <div className="space-y-4">
          <p className="text-sm font-semibold text-slate-100">
            {skillTests[activeSkillModal][currentTestIndex].question}
          </p>

          <div className="space-y-2">
            {skillTests[activeSkillModal][currentTestIndex].options.map((opt, oIdx) => <button
              key={oIdx}
              type="button"
